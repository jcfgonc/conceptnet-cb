...
public class PatternFinderGraal {
	...
	private static int queryPattern(ConjunctiveQuery query, KnowledgeBase kb, final int loopUnrollSize, final boolean nextSolutionCheck,
			final int solutionLimit) throws IteratorException, KnowledgeBaseException {
